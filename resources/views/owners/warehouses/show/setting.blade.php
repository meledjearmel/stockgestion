...
@section('show-content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body tx-center pd-y-20 pd-x-20">
                    ...
                    <h4 class="tx-danger  tx-semibold mg-b-20">Danger: suppression de l'entrepot !</h4>
                    <p class="mg-b-20 mg-x-20">Si vous etes sure de supprimer cet entrepot entrer <strong>{{ $warehouseSlug }}</strong></p>
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex justify-content-center align-content-start flex-column">
            <h4><i class="ion-android-settings"></i> Paramètres {{ $warehouse->name }}</h4>
    ...
    <div class="d-flex align-content-center justify-content-between mt-4">
        <a href="{{ route('warehouse.edit', $warehouse->id) }}" style="cursor:pointer; color: #fff" class="btn btn-primary btn-with-icon">
            <div class="ht-40 justify-content-between">
                <span class="pd-x-15">EDITER L'ENTREPOT</span>
        ...
        <button style="cursor:pointer;" data-toggle="modal" data-target="#modaldemo5" class="btn btn-danger btn-with-icon">
            <div class="ht-40">
                ...
                <span class="pd-x-15">SUPPRIMER L'ENTREPOT</span>
            </div>
        </button>
    </div>
@endsection
