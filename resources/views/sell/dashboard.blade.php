        ...
        <div class="br-pagetitle d-flex justify-content-between align-items-center">
            ...
            <div class="ht-lg-40 bg-gray-200 pd-x-20 d-lg-flex align-items-center justify-content-center">
                <ul class="nav nav-effect nav-effect-1 flex-column flex-lg-row" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="{{ route('sellboard') }}" role="tab">Acceuil</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{ route('selling') }}" role="tab">Vendre</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
                    <div class="bg-purple rounded overflow-hidden">
                        <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                            ...
                            <div class="mg-l-20">
                                <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Ventes d'aujourd'hui</p>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="bg-info rounded overflow-hidden">
                        <div class="pd-x-20 pd-t-20 d-flex align-items-center">
                            ...
                            <div class="mg-l-20">
                                <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Vente du mois</p>
                                <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">1.000.000</p>
                                <span class="tx-11 tx-roboto tx-white-8">Franc CFA XOF</span>
                            </div>
                        </div>
